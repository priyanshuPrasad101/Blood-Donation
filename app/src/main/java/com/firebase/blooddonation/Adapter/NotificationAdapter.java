...
import com.firebase.blooddonation.Model.Notification;
...
getUserInfo(holder.notification_profile_image , holder.notification_name , notification.getSenderId());
    ...
    private void getUserInfo(final CircleImageView circleImageView , final TextView nameTextView , final String sendeId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("users").child(sendeId);
