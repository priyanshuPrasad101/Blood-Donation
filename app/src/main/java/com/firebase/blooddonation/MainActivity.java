...
import com.firebase.blooddonation.Adapter.UserAdapter;
   ...
   // private ProgressBar progressBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  progressBar.findViewById(R.id.progressBar);
        ...
        nav_fullname = nav_view.getHeaderView(0).findViewById(R.id.nav_user_fullnam);
        nav_email = nav_view.getHeaderView(0).findViewById(R.id.nav_user_email);
        nav_bloodgroup = nav_view.getHeaderView(0).findViewById(R.id.nav_user_bloodgrooup);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
       switch(item.getItemId()){
           ...
           case R.id.share:
               ...
               intent14.setType("text/palin");
               intent14.putExtra(Intent.EXTRA_SUBJECT,"Checkout this helpful application");
               intent14.putExtra(Intent.EXTRA_TEXT, "your app link here");
